      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="flex items-baseline gap-2">
            ...
            {count !== undefined && (
              <span className="text-[13px] font-medium text-muted-foreground">(Total {count})</span>
            )}
          </div>
...
export function ListControls({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 px-6 pt-5 lg:px-8">
