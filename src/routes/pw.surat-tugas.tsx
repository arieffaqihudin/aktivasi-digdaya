...
export const Route = createFileRoute("/pw/surat-tugas")({
  component: PwSuratTugas,
});

function PwSuratTugas() {
  return (
    <div>
      <PageHeader
        title="Surat Tugas dari Persuratan"
        breadcrumb={[{ label: "PW", to: "/pw" }, { label: "Dokumen" }, { label: "Surat Tugas" }]}
      ...
      <div className="p-4 sm:p-6">
        <div className="max-w-2xl rounded-xl border border-border bg-card p-6 text-center">
          ...
          <Link to="/pw" className="mt-4 inline-block">
