      ...
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Semua pengajuan dari dashboard PW.</p>
          </div>
              ...
              <div key={item.ticketId} className="rounded-xl border border-border bg-card p-5">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Link to="/pw/status-pengajuan/$ticketId" params={{ ticketId: item.ticketId }} className="inline-flex items-center justify-center rounded-md border border-border bg-background px-3 py-2 text-sm font-medium text-foreground">
                      Detail
                    </Link>
                    {item.status === "PerluPerbaikan" && (
                      <Link to="/pw/status-pengajuan/$ticketId/revisi" params={{ ticketId: item.ticketId }} className="inline-flex items-center justify-center rounded-md bg-primary px-3 py-2 text-sm font-medium text-primary-foreground">
                        Revisi
                      </Link>
                    )}
                  </div>
